      ...
      <section className={StyleSheet.layoutGrid}>
        <div>
          <section className={StyleSheet.info}>
            {/* <svg className={StyleSheet.cart} onClick={() => setClicked(true)} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16">
